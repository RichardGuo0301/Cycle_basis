...
print("\n" + "="*60)
print("STARTING 100 RANDOMIZED BATCH TRIALS")
print("="*60)

with open("batch_results.txt", "w", encoding="utf-8") as out_f:
    out_f.write("Batch testing 100 random combinations of blocked edges\n")
    out_f.write("Map and original flow_B are identical across trials.\n\n")
...
for trial_seed in range(100):
    try:
        ...
        with open("batch_results.txt", "a", encoding="utf-8") as out_f:
            out_f.write(f"\n{'='*80}\n")
